...
{
    auto id = e->getMessageId();

    switch (id){
    case 0x20:
        handleTimePassed(*static_cast<EventT<TimeoutInd> const&>(*e)); //0x20
        break;
    case 0x10:
        handleDirectionChange(*static_cast<EventT<DirectionInd> const&>(*e)); //0x10
        break;
    case 0x40:
        handleFoodPositionChange(*static_cast<EventT<FoodInd> const&>(*e)); //0x40
        break;
    case 0x42:
        handleNewFood(*static_cast<EventT<FoodResp> const&>(*e)); //0x42
        break;
    default:
