...
void Controller::pauseEvent(const PauseInd& pause){
    snakeIsPaused = !snakeIsPaused;
}
...
void Controller::receive(std::unique_ptr<Event> e)
{
    ...
    {
        case TimeoutInd::MESSAGE_ID: if(!snakeIsPaused){return handleTimePassed(*static_cast<EventT<TimeoutInd> const&>(*e));} break;
        case DirectionInd::MESSAGE_ID: if(!snakeIsPaused){return handleDirectionChange(*static_cast<EventT<DirectionInd> const&>(*e));} break;
