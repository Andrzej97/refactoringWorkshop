...
bool Controller::hasBitSelf(Segment newHead)
{
...
bool Controller::whenNotLost1(Segment newHead)
{
    bool lost = false;
...
void Controller::whenNotLost2(Segment newHead)
{
...
void Controller::recieveTimeoutInd(std::unique_ptr<Event>& e)
{
    ...
    bool lost = hasBitSelf(newHead);
    if (not lost)
        lost = whenNotLost1(newHead);
    if (not lost)
        whenNotLost2(newHead);
}

void Controller::recieveDirectionInd(std::unique_ptr<Event>& e)
{
...
void Controller::recieveFoodInd(std::unique_ptr<Event>& e)
{
...
void Controller::recieveFoodResp(std::unique_ptr<Event>& e)
{
