    ...
    if (std::make_pair(newHead.x, newHead.y) == m_foodPosition) {
        ...
        for (auto &segment : m_segments) {
            if (not --segment.ttl) {
                ...
                makeNewPosition(e, & newHead);
            }
        }
    }
}

void changingPosition(std::unique_ptr<Event> e, Segment & newHead, Segment & currentHead)
{
...
void Controller::receive(std::unique_ptr<Event> e)
{
    ...
    {
        void errorHandling(std::unique_ptr<Event> e);
    }
}
