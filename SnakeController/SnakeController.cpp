        ...
        try {
            ...
            try {
                ...
                try {
                    ...
                    bool requestedFoodCollidedWithSnake = false;
                    loop(m_segments, requestedFood, requestedFoodCollidedWithSnake);
...
void Controller::ifLostEqFalse(bool& lost, Segment& newHead)
{
...
void Controller::loop(std::list<Segment> & m_segments, FoodResp & requestedFood, bool & requestedFoodCollidedWithSnake)
{
    for (auto const& segment : m_segments) {
